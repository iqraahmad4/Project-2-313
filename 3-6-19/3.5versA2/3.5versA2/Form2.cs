...
namespace _3._5versA2
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Why are you trying to replace nothing? Selct a coefficient.", "S.I.S.T.E.M: ", MessageBoxButtons.OK);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           ...
           for (int i = 0; i < listBox1.Items.Count; i++)
            ...
            if(sum != 1)
            {
                MessageBox.Show("I say, can't you add? Change the filter coefficients to equal 1.","S.I.S.T.E.M: ", MessageBoxButtons.OK);
                redo = true;
            }
